...
public class AddProductToCartAndPurchase extends TestBase {
    @Test
    ...
    public void userCanPurchase() throws InterruptedException {
        shoppingCartPage=new ShoppingCartPage(Driver);
        shoppingCartPage.proceedToCheckOut();
        Assert.assertTrue(shoppingCartPage.cartPurchaseCompleteMessage.getText().equalsIgnoreCase("Your order on My Store is complete."));
    }
}
